# Generated by Django 4.0.7 on 2023-05-23 11:59
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('operator_type', models.CharField(choices=[('MNO', 'MNO'), ('IPTSP', 'IPTSP')], default='MNO', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('operator_name', models.CharField(choices=[('Grameenphone', 'Grameenphone'), ('Banglalink', 'Banglalink'), ('TeleTalk', 'TeleTalk'), ('Robi', 'Robi'), ('BanglaPhone', 'BanglaPhone'), ('Telebarta', 'Telebarta'), ('NationalPhone', 'NationalPhone'), ('PeoplesTel', 'PeoplesTel'), ('RanksTel', 'RanksTel'), ('BijoyPhone', 'BijoyPhone'), ('Onetel', 'Onetel'), ('DhakaPhone', 'DhakaPhone'), ('ShebaPhone', 'ShebaPhone')], max_length=20)),
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sms_user_operator_credential_config', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('aggregator_operator', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sms_user_destination_config', to='nf_core.smsuseroperatorcredentialconfig')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sms_user_destination_config', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['user', 'operator_name'], name='sms_user_op_user_id_c29282_idx'),
        ),
        migrations.AddIndex(
